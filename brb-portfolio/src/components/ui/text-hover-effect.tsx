    ...
    return (
        ...
        >
            ...
            <motion.text
                ...
                className="font-[helvetica] font-bold fill-transparent text-[2.025rem] stroke-neutral-200 dark:stroke-neutral-800"
            ...
            <text
                ...
                strokeWidth="0.3"
                mask="url(#textMask)"
                className="font-[helvetica] font-bold fill-transparent text-[2.025rem]"
            >
                {text}
            </text>
        </svg>
